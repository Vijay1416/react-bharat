            ...
            <div className="row">
              <div className="col-md-8 mt-4">
                ...
                <div className="shadow-sm standared-type">
                  {schClass.map((value) => {
                    return <Standard class={value} key={value} />;
                  })}
                </div>
              </div>
              <div className="col-md-4 mt-4">
                <div className="hour-box shadow-sm">
                  ...
                  {schDays.map((days) => {
                    return <OpeningHour day={days} key={days} />;
                  })}
                </div>
              </div>
        ...
        <div className="card shadow-sm schoolcard-box">
          <div className="row g-0">
            <div className="col-md-3 text-center">
              <img
                src={schoollogo}
                className="img-fluid schoollogoImg"
                alt="logo"
              />
            </div>
            <div className="col-md-9">
              <div className="card-body">
                ...
                <p className="locate-text">
                  <FmdGoodIcon className="fs-5 text-muted"></FmdGoodIcon> Near
                  Barrackpore Wireless Gate, Barrackpore, West Bengal - 700121
                </p>
                <div className="d-flex">
                  <p className="locate-text">
                    <ApartmentIcon className="fs-5 text-muted"></ApartmentIcon>{" "}
                    Private
                  </p>
                  <p className="locate-text ms-4">
                    <WorkspacePremiumIcon className="fs-5 text-muted"></WorkspacePremiumIcon>{" "}
                    ICSE
                  </p>
                  <p className="locate-text ms-4">
                    <PeopleIcon className="fs-5 text-muted"></PeopleIcon> CoEd
                  </p>
                  <p className="locate-text ms-4">
                    <LocalLibraryIcon className="fs-5 text-muted"></LocalLibraryIcon>{" "}
                    English
                  </p>
                </div>
                ...
                <div className="d-flex">
                  <p className="locate-text">
                    <StarRateIcon className="fs-4 text-warning"></StarRateIcon>{" "}
                    4.0/5.0
                  </p>
                  <p className="ms-4 locate-text">
