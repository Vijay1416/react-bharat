...
import FilterschoolBox from "../search/FilterschoolBox";
...
const NavBar = () => {
  ...
  function handleLogOut() {
    setLoading(true);
    axios
      .post(`https://hammerhead-app-iohau.ondigitalocean.app/user/logout-api`)
      .then((res) => {
        console.log(res);
      })
      .catch((res) => {
  ...
  return (
    <>
      ...
      <nav className="navbar">
        <div className="navbar-container container nav-contx">
          <input
            ...
            name=""
            id=""
            onClick={blockBackgroundOnMobile}
          />
          ...
          <ul className="menu-items">
            <div className="search__container">
              ...
              <i
                className="fa fa-search searchInputIcon"
                aria-hidden="true"
            ...
            {
              <li style={{ width: "30px" }}>
                <div className="reg-color hover-list-color"></div>
              </li>
            }
            {getLogin ? (
              <li>
                <NavLink
                  className="log-color hover-list-color"
                  onClick={showLogin}
                >
                  <b>Login</b>
                </NavLink>
      ...
      {getLogin && <Login getLogin={getLogin} handleLogindisplay={hideLogin} />}
    </>
  );
};
